...
export type ExpressEventParams = [APIGatewayEvent, Context];
...
const getProcessTransformEventParams = (
    serviceName: string,
): EventTransformEventParamsActionProcessor<ExpressEventParams, HTTPEvent<any>> => {
    ...
    return async (payload) => {
        ...
        if (!matchedRoute) {
            return actionResultError(
                ...
                `route not found [${payload.transformedEventParams.path
